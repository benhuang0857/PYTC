...
Route::post('employeeone', 'ProcedureController@UserSelectOneProc')->middleware('cors');
Route::put('employee/update', 'ProcedureController@UserUpdateProc')->middleware('cors');
